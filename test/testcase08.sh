...
# Sourced files 
#-------------------------------------------------------------------------------
function __testcase08_source_lib () {
local module="${1:-}"
local folders=( "${__testcase08_dir}" "${__testcase08_dir}/lib"  "/usr/local/lib" "${HOME}/.local/lib")
local success=false
...
__testcase08_source_lib log.sh
__testcase08_source_lib ini_val.sh
#-------------------------------------------------------------------------------
